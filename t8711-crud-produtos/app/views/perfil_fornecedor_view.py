...
class Perfil_Fornecedor_View:
    ...
    def configurar_janela(self):
        ...
        self.root.title(
            f"{Idioma.t('perfil_fornecedor.janela')} "
            f"{self.perfil.nome}"
        )
    ...
    def criar_componentes(self):
        ...
        self.lbl_titulo = tk.Label(
            self.root,
            text=(
                f"{Idioma.t('perfil_fornecedor.titulo')} "
                f"{self.perfil.nome}"
            ),
            font=("Arial", 12, "bold"),
            wraplength=380
    ...
    def preencher_lista(self):
        ...
        for indice, fornecedor in enumerate(
            ...
            if fornecedor.id in ids_associados:
                self.lst_fornecedores.selection_set(
                    indice
                )
    ...
    def salvar(self):
        ...
        indices_selecionados = (
            self.lst_fornecedores.curselection()
        )
    ...
    def exibir_mensagem(
        ...
        if sucesso:
            ...
            messagebox.showinfo(
                Idioma.t("perfil_fornecedor.sucesso"),
                mensagem,
                parent=self.root
            )
