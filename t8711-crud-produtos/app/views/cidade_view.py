...
class Cidade_View:
    ...
    def configurar_janela(self):
        self.root.title(Idioma.t("janela.cidade")),
    ...
    def ler_dados_cidade(self):
        ...
        if indice < 0:
            raise ValueError (Idioma.t("cidade.selecionar_estado"))
