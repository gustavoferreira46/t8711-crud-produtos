...
class Perfil_Controller:
    ...
    def update(self):
        ...
        try:
            ...
            self.perfil_selecionado.atualizar_dados(
                nome,
                descricao
            )
    ...
    def abrir_fornecedores(self):
        ...
        self.perfil_selecionado.fornecedores = (
            self.perfil_fornecedor_dao
            .get_fornecedores_por_perfil(
                self.perfil_selecionado
            )
        )
    ...
    def salvar_fornecedores(
        ...
        try:
            ...
            view_fornecedores.exibir_mensagem(
                Idioma.t(
                    "perfil_fornecedor.atualizados_sucesso"
                )
            )
